...
@section('content')
  ...
  <form action="{{ route('pembukuan.reklasifikasi.store') }}" method="post">
    @csrf
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-8">
            ...
            <div class="form-text">Masukkan jumlah barang yang dilakukan reklasifikasi barang rusak berat atau usang.</div>
            @error('jumlah_barang')
              <div class="form-text text-danger">{{ $message }}</div>
            @enderror
          </div>
      ...
      <div class="card-footer">
        <div class="hstack gap-2 justify-content-end">
          <a href="{{ route('pembukuan.reklasifikasi.index') }}" class="btn btn-light waves-effect">Kembali</a>
