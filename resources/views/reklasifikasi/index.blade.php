      ...
      <div class="row g-4 align-items-center">
        ...
        <div class="col-sm-auto">
          <div class="d-flex gap-2 flex-wrap">
            <a href="{{ route('pembukuan.reklasifikasi.create') }}" class="btn btn-success add-btn waves-effect">
    ...
    <div class="card-body bg-light-subtle">
      <form action="{{ Request::fullUrlWithQuery(['search' => $filter->search]) }}" method="GET">
        <div class="row g-3">
          ...
          <div class="col-6 col-lg-2">
            <div>
              <a href="{{ route('pembukuan.reklasifikasi.index') }}" class="btn btn-soft-danger waves-effect w-100"> 
      ...
      <div class="table-responsive table-card mb-1">
        <table class="table align-middle">
          ...
          <tbody>
            @foreach ($data as $doc)
              @php
                $detailUrl = route('pembukuan.reklasifikasi.showByDocs', [$doc['slug_dokumen']]);
              @endphp
