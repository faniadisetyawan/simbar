            ...
            @if (auth()->user()->role_id !== 4)
              <div class="col-sm-auto">
                <div class="d-flex gap-2 flex-wrap">
                  <a href="{{ route('penyaluran.spb.create') }}" class="btn btn-success add-btn waves-effect">
        ...
        <div class="card-body bg-light-subtle">
          <form action="{{ Request::fullUrlWithQuery(['search' => $filter['search']]) }}" method="GET">
            <div class="row g-3">
              ...
              <div class="col-6 col-lg-2">
                <div>
                  <a href="{{ route('penyaluran.spb.index') }}" class="btn btn-soft-danger waves-effect w-100"> 
          ...
          <div class="table-responsive table-card mb-1">
            <table class="table align-middle">
              ...
              <tbody>
                @foreach ($data as $doc)
                  @php
                    $detailUrl = route('penyaluran.spb.showByDocs', [$doc['slug_dokumen']]);
                  @endphp
