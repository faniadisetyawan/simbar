<div class="modal fade zoomIn" id="formModal" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content border-0">
      ...
      <form action="{{ route('pembukuan.stock-opname.store') }}" method="post" class="tablelist-form">
        @csrf
        ...
        <div class="modal-body" id="modal-container">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-8">
              ...
              <div class="form-text">Masukkan jumlah barang sesuai kondisi riil.</div>
            </div>
          </div>
...
@push('scripts-modal-stock-opname')
<script>
  ...
  const openFormModal = ({ data, doc }) => {
    ...
    let url = !!data ? 
      `{{ url('pembukuan/stock-opname/barang/${data.id}') }}` 
      : 
      `{{ route('pembukuan.stock-opname.store') }}`;
