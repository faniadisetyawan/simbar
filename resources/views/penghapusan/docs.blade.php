...
@section('content')
                      ...
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          ...
                          <li>
                            ...
                            <form id="formDestroy-{{ $item['id'] }}" action="{{ route('pembukuan.penghapusan.destroyBarang', $item['id']) }}" method="post">
                              @csrf
                              @method('DELETE')
                            </form>
                          </li>
  ...
  @include('components.modal-penghapusan')
  ...
  <div class="modal fade zoomIn" id="uploadModal" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content border-0">
        ...
        <form action="{{ route('pembukuan.penghapusan.uploadDokumen') }}" method="post" enctype="multipart/form-data" class="tablelist-form">
          @csrf
          @method("PUT")
  ...
  <div class="modal fade zoomIn" id="editDocModal" tabindex="-1" aria-labelledby="editDocModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content border-0">
        ...
        <form action="{{ route('pembukuan.penghapusan.updateDoc', $data['slug_dokumen']) }}" method="post" class="tablelist-form">
          @csrf
          @method("PUT")
...
@push('scripts')
  ...
  @stack('scripts-modal-penghapusan')
@endpush
