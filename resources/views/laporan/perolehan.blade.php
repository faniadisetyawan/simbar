    ...
    <div class="col-12 col-sm-6">
      <div class="card">
        ...
        <div class="card-footer">
          <div class="text-end">
            <button type="button" class="btn btn-success btn-label waves-effect" onclick="printReport('{{ $slug }}')">
...
@push('scripts')
  ...
  <script>
    const printReport = (slug) => {
      let tglPembukuan = $('[name="tgl_pembukuan"]').val();

      if (!!tglPembukuan) {
        window.open(`{{ route('laporan.perolehan', '') }}/${slug}?tgl_pembukuan=${tglPembukuan}`, '_blank');
      }
    }
  </script>
@endpush
