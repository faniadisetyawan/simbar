...
@section('content')
  @push('styles')
    <link href="{{ asset('assets/libs/nouislider/nouislider.min.css') }}" rel="stylesheet" type="text/css" />
  ...
  <div class="row">
    <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0">Objek Sewa</h4>
        <div class="page-title-right">
          <ol class="breadcrumb m-0">
            <li class="breadcrumb-item"><a href="{{ url('/') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Objek Sewa</li>
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="card-header border-0">
            <div class="row g-4">
              <div class="col-sm-auto">
                <div>
                  <a href="apps-ecommerce-add-product.html" class="btn btn-success" id="addproduct-btn"><i class="ri-add-line align-bottom me-1"></i> Add Object</a>
                </div>
              </div>
              <div class="col-sm">
